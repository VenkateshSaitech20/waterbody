...
const PendingUsersReport = () => {
    ...
    const getPendingUsers = useCallback(async (searchText) => {
        setIsLoading(true);
    ...
    const handleExport = async () => {
        try {
            ...
            link.href = url;
            link.setAttribute('download', 'pending_users_report.xlsx');
            ...
            <CardContent className='flex justify-between flex-wrap max-sm:flex-col sm:items-center gap-4'>
                <div className='flex gap-4 max-sm:flex-col max-sm:is-full'>
                    <TextFieldStyled
                        ...
                        variant='filled'
                    />
                    <Button variant='tonal' color='primary' onClick={handlePendingUserSearch}>
