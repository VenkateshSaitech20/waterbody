...
const AddWhatsAppTemplate = props => {
    const { open, handleClose, handleTemplateAdded, whatsAppPermission } = props;
    ...
    const handleTemplateSubmit = async (data) => {
        ...
        const response = await apiClient.post('/api/whats-app/template', data);
