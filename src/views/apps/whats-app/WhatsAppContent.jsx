...
import WhatsAppContentSearch from './WhatsAppContentSearch';
import WhatsAppContentList from './WhatsAppContentList';
...
WhatsAppContent.propTypes = {
  ...
  smsDeliveredStatus: PropTypes.any,
};
