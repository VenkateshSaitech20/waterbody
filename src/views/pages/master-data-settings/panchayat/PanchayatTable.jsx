...
import PanchayatDialog from '@/components/dialogs/edit-panchayat-info';
...
const PanchayatTable = ({ masterSettingsPermission }) => {
    ...
    const getPanchayats = useCallback(async (searchText) => {
        setIsLoading(true);
        const response = await apiClient.post("/api/master-data-settings/panchayat/list", {
            searchText,
            page: currentPage,
            pageSize
        });
    ...
    const handleConfirmation = async (confirmed) => {
        setIsLoading(true);
        if (confirmed) {
            const response = await apiClient.put('/api/master-data-settings/panchayat', { id: idToDelete });
            if (response.data.result === true) {
    ...
    return (
        <>
            <Card>
                ...
                />
                <ConfirmationDialog open={open} setOpen={setOpen} type='delete-data' onConfirm={handleConfirmation} name="panchayat" />
            </Card>
            <AddPanchayat
                open={dialogBoxOpen}
