...
const AddTaluk = props => {
    ...
    const handleOnSubmit = async (data) => {
        ...
        const response = await apiClient.post('/api/master-data-settings/taluk', data);
        if (response.data.result === true) {
    ...
    return (
        ...
        >
            <div className='flex items-center justify-between p-6'>
                <Typography variant='h5'>Add Taluk</Typography>
                        ...
                        <Grid container spacing={6}>
                            ...
                            <Grid item xs={12}>
                                <TextFieldStyled
                                    ...
                                    size={"small"}
                                    InputLabelProps={{ shrink: true }}
                                    label={<CustomInputLabel htmlFor='name' text='Taluk Name' />}
                            ...
                            <Grid item xs={12} className='flex gap-4 flex-wrap'>
                                {(masterSettingsPermission?.editPermission === "Y" || masterSettingsPermission?.writePermission === "Y") && (
                                    <Button variant='contained' type='submit'>
                                        {isButtonLoading ? <Loader type="btnLoader" /> : "Add Taluk"}
                                    </Button>
                                )}
                            </Grid>
                        </Grid>
...
export default React.memo(AddTaluk)
