...
const AddHabitation = props => {
    ...
    const [isPanchayatDisabled, setIsPanchayatDisabled] = useState(true);
    ...
    const handleOnSubmit = async (data) => {
        ...
        const response = await apiClient.post('/api/master-data-settings/habitation', data);
        if (response.data.result === true) {
    ...
    return (
        ...
        >
            <div className='flex items-center justify-between p-6'>
                <Typography variant='h5'>Add Habitation</Typography>
                        ...
                        <Grid container spacing={6}>
                            ...
                            <Grid item xs={12}>
                                <Controller
                                    ...
                                    control={control}
                                    defaultValue=''
                                    rules={{ required: registerData.panchayatNameReq }}
                                    render={({ field }) => (
                                        <TextFieldStyled
                                            select
                                            fullWidth
                                            ...
                                            InputLabelProps={{ shrink: true }}
                                            {...field}
                                            error={!!errors.panchayatId || apiErrors?.panchayatId}
                                            helperText={errors?.panchayatId?.message || apiErrors?.panchayatId}
                            ...
                            <Grid item xs={12}>
                                <TextFieldStyled
                                    ...
                                    size={"small"}
                                    InputLabelProps={{ shrink: true }}
                                    label={<CustomInputLabel htmlFor='name' text='Habitation Name' />}
                            ...
                            <Grid item xs={12}>
                                <TextFieldStyled
                                    ...
                                    size={"small"}
                                    InputLabelProps={{ shrink: true }}
                                    label={<CustomInputLabel htmlFor='lgdCode' text='Habitation code' />}
                                    placeholder='Habitation code'
                            ...
                            <Grid item xs={12} className='flex gap-4 flex-wrap'>
                                {(masterSettingsPermission?.editPermission === "Y" || masterSettingsPermission?.writePermission === "Y") && (
                                    <Button variant='contained' type='submit'>
                                        {isButtonLoading ? <Loader type="btnLoader" /> : "Add Habitation"}
                                    </Button>
                                )}
                            </Grid>
                        </Grid>
...
AddHabitation.propTypes = {
    open: PropTypes.any,
    handleClose: PropTypes.func,
    handleDistrictAdded: PropTypes.func,
};

export default React.memo(AddHabitation)
