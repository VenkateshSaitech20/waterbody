...
const AddGWB = props => {
    const { open, handleClose, handleGWBAdded } = props;
    ...
    const handleCountrySubmit = async (data) => {
        ...
        const response = await apiWBDClient.post('/water-body-details/gwb', data);
...
AddGWB.propTypes = {
    ...
    handleGWBAdded: PropTypes.func,
};
export default AddGWB
