...
const PWDTankUpload = () => {
    ...
    const pwdTankExcelApiUrl = '/pwd-tanks/bulk-download';
    ...
    const handlePWDTankSubmit = async (e) => {
        e.preventDefault();
        setApiErrors({});
        if (!fileInput) {
        ...
        const response = await apiWBDClient.post('/pwd-tanks/bulk-import', formData, {
            headers: {
    ...
    return (
        <Card className='h-full'>
            <CardHeader title='PWD TANK' />
            <CardContent>
                <div className='flex flex-col justify-between mb-4'>
                    <div className='flex flex-col items-start'>
                        <form onSubmit={handlePWDTankSubmit}>
                            ...
                            <div className='flex justify-between'>
                                ...
                                <div className="flex">
                                    <Button size="small" variant='contained' startIcon={<i className='bx-download' />} onClick={() => handleExport(apiWBDClient, pwdTankExcelApiUrl, 'PWD Tank')}> Download</Button>
                                </div>
                            </div>
                        </form>
