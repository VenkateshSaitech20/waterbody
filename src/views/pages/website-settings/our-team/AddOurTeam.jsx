    ...
    return (
        ...
        >
            <div className='flex items-center justify-between p-6'>
                <Typography variant='h5'>Add Gallery</Typography>
            ...
            <div>
                <CardContent>
                    <div className='flex max-sm:flex-col items-center gap-6'>
                        {companyImgSrc && <img height={100} width={100} className='rounded w-[100px] h-[100px]' src={companyImgSrc} alt='Logo' />}
                            ...
                            <Grid item xs={12} className='flex gap-4 flex-wrap'>
                                {(websiteSettingsPermission?.editPermission === "Y" || websiteSettingsPermission?.writePermission === "Y") && (
                                    <Button variant='contained' type='submit'>
                                        {isButtonLoading ? <Loader type="btnLoader" /> : "Add Gallery"}
                                    </Button>
                                )}
                            </Grid>
                        </Grid>
