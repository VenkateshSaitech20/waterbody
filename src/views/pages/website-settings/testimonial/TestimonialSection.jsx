...
const TestimonialSection = () => {
    ...
    const handleTestimonialEdit = async (data) => {
        setApiErrors({});
        setIsButtonLoading(true);
        const changedCheckBox = checked ? "Y" : "N";
        const postData = { ...data, sectionType: "testimonial", isfrontendvisible: changedCheckBox };
    ...
    return (
        <Card>
            ...
            {!isLoading && (
                <CardContent>
                    <form autoComplete='off' onSubmit={handleSubmit(handleTestimonialEdit)}>
