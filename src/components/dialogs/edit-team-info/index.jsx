...
const EditTeamInfo = ({ open, setOpen, data, id, handleTeamUpdate }) => {
    ...
    const handleUpdateTeamData = async (data) => {
        if (apiErrors?.image) {
            return;
        }
        setIsLoading(true);
        ...
        const { data: { result, message } } = await apiClient.post('/api/website-settings/our-team', formData, {
            headers: {
    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit(handleUpdateTeamData)}>
...
EditTeamInfo.propTypes = {
    ...
    data: PropTypes.any,
    id: PropTypes.any,
    handleTeamUpdate: PropTypes.any,
