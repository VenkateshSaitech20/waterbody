...
const PanchayatDialog = ({ open, setOpen, data, id, handleDataUpdate }) => {
    ...
    const handleOnSubmit = async (data) => {
        setIsLoading(true);
        if (id) data.id = id;
        const { data: { result, message } } = await apiClient.post('/api/master-data-settings/panchayat', data);
        if (result === true) {
...
export default PanchayatDialog
